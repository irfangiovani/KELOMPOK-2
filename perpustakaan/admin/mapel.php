...
if( isset($_POST["carimapel"]) ) {
  $buku_mapel_kelas = carimapel($_POST["keywordmapel"]);
}
...
<body>
  ...
  <div id="wrapper">
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">Mapel Kelas</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <a href="tambah_mapel.php" class="btn btn-info icon-plus">Tambah Buku Mapel Kelas</a>
    <br><br>
<div class="content">
      <div class="box">
