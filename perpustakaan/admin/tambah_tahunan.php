...
if( isset($_POST["submit"])){
    ...
    $id_judul_buku_tahunan = $_POST["id_judul_buku_tahunan"];
    $judul_buku_tahunan = $_POST["judul_buku_tahunan"];
    ...
    //query insert data
    mysqli_query($conn, "INSERT INTO buku_tahunan_siswa VALUES ('$id_judul_buku_tahunan', '$judul_buku_tahunan','$penerbit','$tahun_terbit', '$untuk_kelas',  '$gambar_sampul','$stok')");
...
<body>
    ...
    <form action="" method="post">
        <ul>
            <li>
                <label for="id_judul_buku_tahuna">Kode Buku Literasi : </label>
